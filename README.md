...
Building Python-based backend projects using **FastAPI**, and experimenting with **data pipelines** to better understand data engineering workflows.

👯 **I’m looking to collaborate on**
Open-source **Python backend systems**, **API services**, and **data engineering projects** involving data ingestion, processing, and automation.

🌱 **I’m currently learning**
**Backend architecture**, **Data engineering concepts**, **data pipeline development**, and improving my skills with modern Python backend tools.
